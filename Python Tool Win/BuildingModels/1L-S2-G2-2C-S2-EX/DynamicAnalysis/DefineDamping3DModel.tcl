...
set periodForRayleighDamping_1 0.163; 
set periodForRayleighDamping_2 0.137; 
...
set alpha1 [expr $alpha1Coeff*0.100] 
set alpha2 [expr $alpha2Coeff*0.100] 
# Assign damping to wood panel elements 
region 1 -eleRange	700000	700030	-rayleigh	0	$alpha2	0	0; 
