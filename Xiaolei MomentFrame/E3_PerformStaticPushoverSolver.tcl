...
RunAndLog $RunLog "Pushover Analysis Started"
wipeAnalysis;
...
set Tol 1.0e-4;                        # Convergence Test: tolerance
...
set Nsteps [expr round($Dmax/$Dincr)];        # number of pushover analysis steps
...
if {$ok != 0} {      
	...
	RunAndLog $RunLog "First try fail .." 
	set controlDisp [nodeDisp $IDctrlNode $IDctrlDOF];
	set remainDisp [expr $Dmax - $controlDisp];
	RunAndLog $RunLog "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n++ There are $remainDisp more inches to push after first try.\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n";
	
	set controlDisp [nodeDisp $IDctrlNode $IDctrlDOF];
	set remainDispS [expr $Dmax - $controlDisp];
	RunAndLog $RunLog "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n++ There are $remainDispS more inches to push, before parameters switch.\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n";

	set ok [POParameterSwitch $IDctrlNode $IDctrlDOF $Dmax $Dincr $Tol $Tol $maxNumIter 10 40 $RunLog];
	
	set controlDisp [nodeDisp $IDctrlNode $IDctrlDOF];
	set remainDispE [expr $Dmax - $controlDisp];

	
	if {$ok != 0 } {
		RunAndLog $RunLog "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n++ Pushover analysis get stuck.\n++ There are $remainDispS more inches to push, before parameters switch.\n++ There are $remainDispE more inches to push, after parameters switched.\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n";			
	} elseif {$remainDispE == 0 } {
		RunAndLog $RunLog "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n++ Pushover analysis complete.\n++ There are $remainDispS more inches to push, before parameters switch.\n++ There are $remainDispE more inches to push, after parameters switched.\n+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n";			
	}			
};      # end if ok !0

if {$ok == 0} {
	RunAndLog $RunLog "Pushover analysis completed SUCCESSFULLY";
} else {
	RunAndLog $RunLog "Pushover analysis completed FAILED"; 
}


RunAndLog $RunLog "DonePushover"
